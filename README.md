...
It starts at version `0.1.0`. The original MIT copyright notice is retained;
new modifications may be copyrighted by `[YOUR NAME OR COMPANY]`.

## Installation
### Manual installation

Copy `custom_components/buspro` into the `custom_components` directory of
your Home Assistant configuration.

### HACS

After uploading this project to GitHub, add your repository URL in HACS as a
custom repository with category **Integration**. Select **HDL Buspro** and
download it.
